          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed !mb-5 text-[15px]">
                Mono PERC (Passivated Emitter and Rear Contact) modules are an advanced solar technology designed to enhance energy generation by minimizing power loss and increasing cell efficiency. With improved light absorption and better overall performance, these modules are widely used in modern solar power systems for reliable and sustainable energy production.              </p>
              <Link
                href="/contact"
