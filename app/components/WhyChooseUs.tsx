        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 !gap-4 border border-gray-100 !mt-8">
          {reasons.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative !p-6 md:!p-12 bg-white border border-gray-100 flex flex-col items-center text-center group cursor-pointer overflow-hidden min-h-[320px] justify-center"
            >
