...
export default function DealerApplyPage() {
  ...
  const [form, setForm] = useState<FormState>({
    refNo: `GCS-DLR-${Math.floor(100000 + Math.random() * 900000)}`,
    firmName: "",
    address: "",
    city: "",
    pinCode: "",
  ...
  // Benefits list
  const benefits = [
    { code: "a", title: "Best Price", desc: "Enjoy Tier-1 manufacturer level pricing margins directly." },
    { code: "b", title: "Better Margin", desc: "Higher profitability margins compared to retail markets." },
    { code: "c", title: "Quarterly Bonus", desc: "Performance-linked cash incentives and rebate bonuses." },
    { code: "d", title: "Monthly Leads", desc: "Geolocated organic buyer leads routed directly to your team." },
    { code: "e", title: "Always Available", desc: "Priority stock allocation with minimal dispatch delay." },
    { code: "f", title: "International Trip", desc: "Annual target-achiever paid international tour campaigns." }
  ];
    ...
    <main className="min-h-screen bg-slate-50 text-primary">
      ...
      <section className="web-only relative overflow-hidden bg-[#0a2540] text-white !pt-40 sm:!pt-48 md:!pt-56 !pb-20 md:!pb-24">
        ...
        <div className="relative z-10 max-w-4xl !mx-auto !px-6 text-center">
          <span className="inline-block bg-[#e11d48]/20 text-[#e11d48] border border-[#e11d48]/30 !px-5 !py-1.5 rounded-full text-[0.7rem] font-black uppercase tracking-[0.2em] !mb-5">
            Official Dealer Program
          </span>
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black uppercase tracking-tighter !mb-4 leading-none">
            Authorized Dealer <span className="text-[#e11d48]">Registration</span>
          </h1>
          <p className="text-white/70 text-lg max-w-2xl !mx-auto leading-relaxed font-medium">
            Become an authorized dealer of GCS Solar Kits &amp; GCS Panels. Fill and sign the official application form below to start our verification process.
          </p>
        </div>
      </section>
                ...
                >
                  ...
                  {step === 1 && (
                    <div className="flex flex-col !gap-8">
                      <div>
                        <span className="text-[#e11d48] font-black uppercase tracking-widest text-xs block !mb-1">Section 01</span>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 !gap-8">
                        ...
                        <div className="relative group/field">
                          ...
                          <input
                            type="text"
                            className="peer w-full !pl-10 !pr-0 !py-3 sm:!py-6 bg-transparent border-b-2 border-slate-200 focus:border-[#e11d48] outline-none transition-all font-bold text-sm sm:text-base md:text-lg text-primary placeholder-transparent"
                            placeholder="Registered Firm Name"
                            id="firmName"
                            value={form.firmName}
                            onChange={(e) => handleInputChange("firmName", e.target.value)}
                          />
                          <label htmlFor="firmName" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                        ...
                        <div className="relative border-b-2 border-slate-200 !py-3 flex flex-col justify-end">
                          <label className="text-[10px] font-black uppercase tracking-widest text-[#e11d48] block !mb-2">Firm Type *</label>
                            ...
                            {["Private Ltd.", "Partnership", "Proprietary"].map((type) => (
                              <label key={type} className="flex items-center !gap-1.5 cursor-pointer font-bold text-xs sm:text-sm text-slate-700 whitespace-nowrap">
                                <input
                                  ...
                                  className="accent-[#e11d48] w-3.5 h-3.5 sm:w-4 sm:h-4"
                                />
                                <span>{type}</span>
                              </label>
                            ))}
                      ...
                      <div className="relative group/field">
                        ...
                        />
                        <label htmlFor="address" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                          Corporate Address *
                        </label>
                        <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full shadow-[0_2px_10px_rgba(225,29,72,0.5)]"></div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 !gap-8">
                        ...
                        <div className="relative group/field">
                          <input
                            type="text"
                            className="peer w-full !pl-0 !pr-0 !py-3 sm:!py-6 bg-transparent border-b-2 border-slate-200 focus:border-[#e11d48] outline-none transition-all font-bold text-sm sm:text-base md:text-lg text-primary placeholder-transparent"
                            placeholder="City"
                            id="city"
                            value={form.city}
                            onChange={(e) => handleInputChange("city", e.target.value)}
                          />
                          <label htmlFor="city" className="absolute left-0 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            City *
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full"></div>
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="pinCode" className="absolute left-0 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            Pin No. *
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full"></div>
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="district" className="absolute left-0 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            Dist. *
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full"></div>
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="state" className="absolute left-0 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            State *
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full"></div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 !gap-8">
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="telNo" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            Telephone No.
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full"></div>
                        </div>
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="resNo" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            Residential No.
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full"></div>
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 !gap-8">
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="faxNo" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            Fax No.
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full"></div>
                        </div>
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="mobileNo" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            Mobile No. *
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full shadow-[0_2px_10px_rgba(225,29,72,0.5)]"></div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 !gap-8">
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="email" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            Email Address *
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full shadow-[0_2px_10px_rgba(225,29,72,0.5)]"></div>
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="website" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            Web Site
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full"></div>
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 !gap-8">
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="gstn" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            GSTN No.
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full"></div>
                        </div>
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="cstNo" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            CST No.
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full"></div>
                        </div>
                  ...
                  {step === 2 && (
                    <div className="flex flex-col !gap-8">
                      <div>
                        <span className="text-[#e11d48] font-black uppercase tracking-widest text-xs block !mb-1">Section 02</span>
                          ...
                          {form.personnel.map((person, idx) => (
                            <div key={idx} className="grid grid-cols-1 md:grid-cols-12 !gap-4 !p-5 md:!py-4 items-center">
                              ...
                              <div className="col-span-1 md:col-span-6">
                                <span className="md:hidden block text-xs uppercase tracking-widest text-[#e11d48] font-black !mb-1.5">Name</span>
                                <div className="relative">
                                  <input
                                    type="text"
                                    className="w-full bg-white border border-slate-200 rounded-xl !px-4 !py-3 text-sm font-bold text-slate-800 outline-none focus:border-[#e11d48] transition-colors"
                  ...
                  {step === 3 && (
                    <div className="flex flex-col !gap-8">
                      <div>
                        <span className="text-[#e11d48] font-black uppercase tracking-widest text-xs block !mb-1">Section 03</span>
                        <h3 className="text-lg sm:text-3xl font-black text-primary uppercase tracking-tighter">Dealership Terms & Payment</h3>
                        <p className="text-slate-400 text-sm !mt-1">Review target commitments, dealer benefits, and make the registration fee transaction.</p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 !gap-8">
                        ...
                        <div className="bg-slate-50 border border-slate-200/60 rounded-[2rem] !p-8 flex flex-col !gap-4 relative overflow-hidden">
                          ...
                          <div>
                            ...
                            <h4 className="text-3xl font-black text-[#0a2540] !mt-1">₹ 15,000</h4>
                            <p className="text-xs font-bold text-[#f3a323] uppercase tracking-wider !mt-1">100% Refundable Deposit</p>
                          </div>
                          <p className="text-slate-500 text-xs leading-relaxed">
                            One-time dealership registration fee of Rs. 15,000/= is payable via NEFT transfer. The deposit is fully refundable at the termination of the dealer relationship.
                          </p>
                        </div>
                        ...
                        <div className="bg-slate-50 border border-slate-200/60 rounded-[2rem] !p-8 flex flex-col !gap-4 relative overflow-hidden">
                          ...
                          <div>
                            ...
                            <h4 className="text-3xl font-black text-[#0a2540] !mt-1">₹ 6,00,000</h4>
                            <p className="text-xs font-bold text-[#e11d48] uppercase tracking-wider !mt-1">First Order Threshold (6 Lakhs)</p>
                          </div>
                          <p className="text-slate-500 text-xs leading-relaxed">
                            To qualify as an active regional dealer, your first commercial order of GCS Solar Kits (3KW / 5KW) and GCS panels must meet the minimum of Rs. 6 Lakhs.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col !gap-4">
                        <h4 className="text-lg font-black text-primary uppercase tracking-tight">Authorized Dealer Benefits</h4>
                        <div className="grid grid-cols-1 md:grid-cols-3 !gap-6">
                          {benefits.map((b) => (
                            <div key={b.code} className="bg-white border border-slate-200/50 rounded-2xl !p-5 hover:shadow-md transition-shadow">
                              <div className="flex items-center !gap-3 !mb-2.5">
                                <span className="w-6 h-6 rounded-full bg-[#e11d48]/10 text-[#e11d48] flex items-center justify-center text-xs font-black uppercase">
                                  {b.code}
                                </span>
                      ...
                      <div className="!pt-6 border-t border-slate-200 flex flex-col !gap-4">
                        <div className="bg-red-50/50 border border-[#e11d48]/10 rounded-2xl !p-6 flex !gap-4">
                          <button
                            type="button"
                            onClick={() => handleInputChange("agreedToTerms", !form.agreedToTerms)}
                            className="flex-shrink-0 text-[#e11d48] !mt-1 outline-none animate-pulse"
                          >
                            {form.agreedToTerms ? (
                              <CheckSquare className="w-6 h-6 fill-[#e11d48]/10" />
                            ) : (
                  ...
                  {step === 4 && (
                    <div className="flex flex-col !gap-8">
                      <div>
                        <span className="text-[#e11d48] font-black uppercase tracking-widest text-xs block !mb-1">Section 04</span>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 !gap-8">
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="ownerName" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                        ...
                        <div className="relative group/field">
                          ...
                          />
                          <label htmlFor="designation" className="absolute left-10 -top-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground peer-placeholder-shown:text-sm sm:peer-placeholder-shown:text-base peer-placeholder-shown:top-4 sm:peer-placeholder-shown:top-6 peer-focus:-top-4 peer-focus:text-[#e11d48] transition-all">
                            Designation / Role *
                          </label>
                          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#e11d48] transition-all duration-500 group-focus-within/field:w-full shadow-[0_2px_10px_rgba(225,29,72,0.5)]"></div>
                      ...
                      <div className="flex flex-col !gap-4">
                        <label className="text-[10px] font-black uppercase tracking-widest text-[#e11d48] block">Signature Type *</label>
                        ...
                        <div className="border-2 border-slate-200 border-dashed rounded-3xl !p-6 bg-slate-50 relative min-h-[160px] flex items-center justify-center">
                          ...
                          {form.signatureType === "type" && (
                            <div className="w-full max-w-lg flex flex-col !gap-4">
                              <input
                                type="text"
                                className="w-full bg-white border border-slate-200 rounded-2xl !px-5 !py-4 text-base font-bold text-slate-800 outline-none focus:border-[#e11d48]"
                      ...
                      {/* Legal notice alert */}
                      <div className="bg-amber-50 border border-amber-200/50 rounded-2xl !p-6 flex !gap-4 text-amber-800 text-xs leading-relaxed font-semibold">
                        <ShieldAlert className="w-5 h-5 flex-shrink-0 text-amber-600" />
                        <div>
                          <span className="font-black uppercase tracking-wide block !mb-1">Legal Agreement Requirement</span>
                          After signing up and submitting this dealer form, you will be required to sign a formal legal agreement with us for the dealership before products can be dispatched.
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="web-only flex justify-between items-center !pt-8 border-t border-slate-100 !mt-8">
                    ...
                    {step < 4 ? (
                      <button
                        type="button"
                        onClick={nextStep}
                        className="btn-primary !px-8 !py-4.5 !rounded-2xl"
                      >
                        <span>Continue</span>
          ...
          >
            ...
            <div className="flex flex-col !gap-3">
              ...
              <p className="text-slate-500 font-medium max-w-md mx-auto text-sm leading-relaxed">
                Your dealer application has been received and registered under Reference Number <span className="font-mono font-bold text-slate-700">{form.refNo}</span>.
              </p>
            </div>
              ...
              <ul className="flex flex-col !gap-3.5 text-xs text-slate-600 font-medium">
                ...
                <li className="flex !gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-[10px] !mt-0.5">We will match the ₹ 15,000 security deposit with HDFC bank logs.</p>
                  </div>
                </li>
                <li className="flex !gap-3">
        ...
        <div className="print-card border border-black p-8 bg-white text-black space-y-6">
          ...
          <div className="flex justify-between items-start border-b-2 border-black pb-4">
            ...
            <div className="text-right text-xs">
              <div className="font-bold">DEALER APPLICATION FORM</div>
          ...
          <div className="space-y-2 text-[10px]">
            <p className="font-bold">If you are interested for Dealership, then:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li>Dealer Amount (100% Refundable) One time: <span className="font-bold">Rs. 15,000/= (Through NEFT)</span></li>
              ...
              <li>First Order should be <span className="font-bold">Rs. 6 Lakhs</span></li>
            </ul>
          ...
          <div className="text-center font-bold text-red-600 italic text-[10px] mt-4">
            After signing up as a dealer, you will be required to sign a legal agreement with us for the dealership.
          </div>

          {/* Dealer Benefits */}
          <div>
            <h4 className="font-bold text-[11px] uppercase tracking-wider mb-2 bg-gray-100 p-1 text-center">Dealer Benefits:</h4>
            <div className="grid grid-cols-2 gap-2 text-[10px]">
              <div>a. Best price</div>
              <div>b. Better Margin</div>
              <div>c. Quarterly Bonus</div>
              <div>d. Monthly Customer leads</div>
              <div>e. Always Availability of Product</div>
              <div>f. Yearly International Trip</div>
            </div>
          </div>
